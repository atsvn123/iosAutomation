...
class zxtouch:
    ...
    def add_photo_from_pc_file(self, image_path, extension=None, chunk_size=1200):
        """Read a local PC image file, upload it to the device, and add it to Photos."""
        if extension is None:
            extension = image_path.rsplit(".", 1)[-1] if "." in image_path else "jpg"
        with open(image_path, "rb") as image_file:
            return self.add_photo_from_bytes(image_file.read(), extension=extension, chunk_size=chunk_size)
